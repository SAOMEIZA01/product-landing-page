  ...
  return (
    <>
      ...
      >
        ...
        {/* Sidebar */}
        <aside
          className={`absolute top-0 left-0 h-full w-60 bg-white dark:bg-slate-800 shadow transform transition-transform duration-300 ${
        ...
        >
          ...
          <nav className="flex flex-col mt-5 p-5 space-y-6">
            {sections.map((s) => (
              <button
                key={s}
                onClick={() => scrollTo(s)}
